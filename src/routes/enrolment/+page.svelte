<script lang="ts">
    import Enrolment from '../../components/Enrolment.svelte';
...
<div class="ml-5 ">
    ...
    <List class="mx-auto w-10/12" list="none" >
        ...
        <Li class="my-3"><strong>Step 3:</strong> Two weeks before the participant’s first lesson, send visual story (link), to be read before the participant’s first lesson.</Li>
