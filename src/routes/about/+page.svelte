...
<List class="max-w-none pl-5 mt-2 space-y-1" list="none">
    ...
    <Li class="py-2">Despite this, there are currently only three ASD Judo programs throughout Australia. We’ve created this toolkit to enable judo instructors who do not have much experience with children with Autism to create a safe and nurturing program for this population.</Li>
</List>
</div>